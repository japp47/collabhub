...
import VideoFormContainer1 from "../components/VideoFormContainer1";
import RequestSection from "../components/RequestSection";
import Header1 from "../components/Header1";
import styles from "./RequestLogCreator.module.css";
const RequestLogCreator: FunctionComponent = () => {
  return (
    <div className={styles.requestLogCreator}>
      <div className={styles.requestLogCreatorChild} />
      <div className={styles.requestLogCreatorItem} />
      <div className={styles.requestLogCreatorInner} />
      ...
      <div className={styles.requestLogCreatorChild1} />
      ...
      <div className={styles.requestLogCreatorChild2} />
      <Header1 />
    </div>
  );
};

export default RequestLogCreator;
