...
import VideoFormContainer from "../components/VideoFormContainer";
import RequestSection from "../components/RequestSection";
import Header from "../components/Header";
import styles from "./RequestLogEditor.module.css";
const RequestLogEditor: FunctionComponent = () => {
  const navigate = useNavigate();

  const onWorkspaceTextClick = useCallback(() => {
    navigate("/workspace-editor");
  }, [navigate]);

  return (
    <div className={styles.requestLogEditor}>
      <div className={styles.requestLogEditorChild} />
      <div className={styles.requestLogEditorItem} />
      <div className={styles.requestLogEditorInner} />
      ...
      <TestimonialsContainer tetimonials={false} />
      ...
      <div className={styles.heroSection}>
        <div className={styles.lottiePlayerSvg}>
          <img className={styles.clipPathGroup} alt="" src="/undefined41.png" />
      ...
      <div className={styles.requestLogEditorChild1} />
      <div className={styles.groupGroup}>
        <img className={styles.groupIcon1} alt="" src="/undefined56.png" />
        ...
        <div className={styles.chatbox}>
          ...
          <div className={styles.circularChipParent}>
            ...
            <div className={styles.transferOption}>
              ...
              <img className={styles.uuserIcon} alt="" src="/undefined60.png" />
              <div className={styles.mathewParent}>
                ...
                <div className={styles.instantTransferBetweenContainer}>
                  <p
                    className={styles.simplifyYourWorkflow}
        ...
        <div className={styles.frameParent}>
          ...
          <div className={styles.maskGroupContainer}>
            <img
              ...
              src="/undefined63.png"
            />
            <div className={styles.upload}>Share</div>
          </div>
          <div className={styles.frameDiv}>
            <img
              ...
              src="/undefined64.png"
            />
            <div className={styles.upload}>Rename</div>
          </div>
          <div className={styles.maskGroupParent1}>
            <img
              ...
              src="/undefined64.png"
            />
            <div className={styles.upload}>Delete</div>
          </div>
        </div>
        <img className={styles.groupIcon2} alt="" src="/undefined65.png" />
        <img className={styles.groupIcon3} alt="" src="/undefined66.png" />
        <VideoFormContainer />
      </div>
      <RequestSection requestCount="Requests" groupDiv={false} />
      <img className={styles.email1Icon} alt="" src="/undefined73.png" />
      <div className={styles.requestLogEditorChild2} />
      <Header
        imageDimensions="/undefined78.png"
        onWorkspaceTextClick={onWorkspaceTextClick}
      />
    </div>
  );
};

export default RequestLogEditor;
